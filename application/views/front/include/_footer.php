            ...
            <div class="dtr-footer-main">
                <div class="container"> 
                    ...
                    <div class="row"> 
                        ...
                        <!-- column 1 starts -->
                        <div class="col-12 col-md-3 small-device-space"> <img src="<?= base_url()?>assets/images/logo-light.png" alt="logo">
                            <p class="dtr-mt-20">@2021.  Grawlix</p>
                        </div>
                        <!-- column 1 ends --> 
                        
                        <!-- column 2 starts -->
                        <div class="col-12 col-md-2 small-device-space">
                            <h4>Links</h4>
                            <ul class="dtr-list-compact">
                        ...
                        <div class="col-12 col-md-2 small-device-space">
                            ...
                            <ul class="dtr-list-compact">
                                ...
                                <li><a href="#">Personal Coach</a></li>
                                <li><a href="#">Transition Coach</a></li>
                                <li><a href="#">Career Coach</a></li>
                                <li><a href="#">Online Life Coach</a></li>
                            </ul>
                        </div>
                        <!-- column 3 ends --> 
